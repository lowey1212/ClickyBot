...
- `ClickyBot-Setup-0.1.6.exe` — compressed per-user installer. It installs to `%LOCALAPPDATA%\Programs\ClickyBot`, creates Start Menu and desktop shortcuts, and opens ClickyBot.
- `ClickyBot-Portable-0.1.6-win-x64.zip` — portable copy for users who prefer to extract and run the app.
